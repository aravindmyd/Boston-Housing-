...
from utils import save_df_to_bq,get_table_as_df
import logging as log
log.basicConfig(level=log.INFO)

def init(project_id : str = "axial-iris-354312", dataset_name : str = "boston_housing_dataset",write_table_name : str = 'fe_table') -> DataFrame:
